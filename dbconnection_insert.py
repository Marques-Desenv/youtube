...
columns_names = (  'href', 'channel', 'title', 'title_key_words', 'views_', 'date_', 'likes', 'deslikes', 'comments_', 'tags', 'time_duration',
                   'img_common_color', 'img_face', 'autoplay_href', 'autoplay_channel', 'autoplay_title', 'autoplay_title_key_words', 'autoplay_views',
                   'autoplay_date', 'autoplay_likes', 'autoplay_deslikes', 'autoplay_comments', 'autoplay_tags', 'autoplay_time_duration',
                   'autoplay_img_common_color', 'autoplay_img_face', 'secondary1_href', 'secondary1_channel', 'secondary1_title',
                   'secondary1_title_key_words', 'secondary1_views', 'secondary1_date', 'secondary1_likes', 'secondary1_deslikes',
                   ...
                   'secondary2_likes', 'secondary2_deslikes', 'secondary2_comments', 'secondary2_tags', 'secondary2_time_duration',
                   'secondary2_img_common_color', 'secondary2_img_face', 'secondary3_href', 'secondary3_channel', 'secondary3_title',
                   'secondary3_title_key_words', 'secondary3_views', 'secondary3_date', 'secondary3_likes', 'secondary3_deslikes',
