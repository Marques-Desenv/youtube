...
def beautiful_scrape(href):
    ...
    for title in soup.find_all("a", class_="yt-simple-endpoint style-scope yt-formatted-string"):
        print(title.get_text('\n'))

    # channel = soup.select("yt-simple-endpoint style-scope yt-formatted-string")
    # channel = soup.find("a", class_="yt-simple-endpoint style-scope yt-formatted-string")
    # channel = channel.string

    # title = soup.select()
    # views_ = soup.select('div.style-scope.ytd-app:nth-child(12) ytd-page-manager.style-scope.ytd-app:nth-child(4) ytd-watch-flexy.style-scope.ytd-page-manager.hide-skeleton:nth-child(2) div.style-scope.ytd-watch-flexy:nth-child(8) div.style-scope.ytd-watch-flexy:nth-child(1) div.style-scope.ytd-watch-flexy div.style-scope.ytd-watch-flexy:nth-child(5) div.style-scope.ytd-watch-flexy ytd-video-primary-info-renderer.style-scope.ytd-watch-flexy div.style-scope.ytd-video-primary-info-renderer div.style-scope.ytd-video-primary-info-renderer:nth-child(6) div.style-scope.ytd-video-primary-info-renderer:nth-child(1) div.style-scope.ytd-video-primary-info-renderer:nth-child(1) yt-view-count-renderer.style-scope.ytd-video-primary-info-renderer > span.view-count.style-scope.yt-view-count-renderer').text
